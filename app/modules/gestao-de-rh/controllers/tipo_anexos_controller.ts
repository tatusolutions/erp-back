...
import TipoAnexoService from '../services/tipo_anexo_service.js'

export default class TipoAnexosController {
  constructor(private service = new TipoAnexoService()) {}
  ...
  async update({ params, request, response }: HttpContext) {
    ...
    return response.ok({
      data: {
        message: 'Tipo de anexo atualizado com sucesso',
      },
    })
  }
