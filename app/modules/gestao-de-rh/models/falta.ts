...
export default class Falta extends BaseModel {
  ...
  @column()
  public  declare colaborador_id: number;

  @column()
  public  declare data_inicio: string;

  @column()
  public  declare data_fim: string;

  @column()
  public  declare  data_referencia: string;
  ...
  @column()
  public  declare duracao: number;

  @column()
  public  declare motivo_rejeicao: string | null;

  @column()
  public  declare aprovado_por: number | null;
